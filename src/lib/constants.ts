...
export const PORTFOLIO_ALLOCATIONS: { name: string; committee: string; alloted: boolean }[] = [
	{ name: "Nirmala Sitaraman", committee: "aippm", alloted: true },
	{ name: "Narendra Modi", committee: "aippm", alloted: true },
	{ name: "Piyush Goyal", committee: "aippm", alloted: true },
	{ name: "Nitin Gadkari", committee: "aippm", alloted: true },
	{ name: "Amit Shah", committee: "aippm", alloted: true },
	{ name: "Rajnath Singh", committee: "aippm", alloted: true },
	{ name: "Ashwini Vaishnaw", committee: "aippm", alloted: true },
	{ name: "Dharmendra Pradhan", committee: "aippm", alloted: true },
	{ name: "Shivraj Chouhan", committee: "aippm", alloted: true },
	{ name: "Yogi Adityanath", committee: "aippm", alloted: true },
	{ name: "Bhupender Yadav", committee: "aippm", alloted: true },
	{ name: "Rahul Gandhi", committee: "aippm", alloted: true },
	{ name: "Shashi Tharoor", committee: "aippm", alloted: true },
	{ name: "Priyanka Gandhi", committee: "aippm", alloted: true },
	{ name: "P Chidambaram", committee: "aippm", alloted: true },
	{ name: "Supriya Sule", committee: "aippm", alloted: true },
	{ name: "Mamata Banerjee", committee: "aippm", alloted: true },
	{ name: "Akhilesh Yadav", committee: "aippm", alloted: true },
	{ name: "Arvind Kejriwal", committee: "aippm", alloted: true },
	{ name: "Raghav Chada", committee: "aippm", alloted: true },
	{ name: "Eknath Shinde", committee: "mla", alloted: false },
	{ name: "Devendra Fadnavis", committee: "mla", alloted: true },
	{ name: "Supriya Sule", committee: "mla", alloted: true },
	{ name: "Uddhav Thackeray", committee: "mla", alloted: true },
	{ name: "Nana Patole", committee: "mla", alloted: true },
	{ name: "Aaditya Thackeray", committee: "mla", alloted: false },
	{ name: "Raj Thackeray", committee: "mla", alloted: false },
	{ name: "Sharad Pawar", committee: "mla", alloted: true },
	{ name: "Chandrakant Patil", committee: "mla", alloted: false },
	{ name: "Ravi Rana", committee: "mla", alloted: false },
	{ name: "Aditi Tatkare", committee: "mla", alloted: true },
	{ name: "Sudhir Mungantiwar", committee: "mla", alloted: false },
	{ name: "Uday Samant", committee: "mla", alloted: true },
	{ name: "Vijay Wadettiwar", committee: "mla", alloted: false },
	{ name: "Jayant Patil", committee: "mla", alloted: true },
	{ name: "Jitendra Awhad", committee: "mla", alloted: false },
	{ name: "Girish Mahajan", committee: "mla", alloted: false },
	{ name: "Radhakrishna Vikhe Patil", committee: "mla", alloted: false },
	{ name: "Bachchu Kadu", committee: "mla", alloted: true },
	{ name: "Mangal Prabhat Lodha", committee: "mla", alloted: false },
	{ name: "Rohit Pawar", committee: "mla", alloted: true },
	{ name: "Dada Bhuse", committee: "mla", alloted: false },
];
