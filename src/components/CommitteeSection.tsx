          ...
          <div className="overflow-y-auto h-screen w-full">
            {committee && (
              <div className="px-6 py-10 md:px-12 pb-12 max-w-5xl mx-auto">
                ...
                <div className="mt-16">
                  ...
                  <div className="max-h-[50vh] overflow-x-auto">
                    <table className="w-full">
                      <tbody className="max-h-[20vh] overflow-scroll">
                ...
                <div className="mt-4">
                  <a
                    href="https://docs.google.com/spreadsheets/d/1cIZ12J1UkLNx9dKCrdFaQbx1sM6Z92YSgm3WGKD8Qd8/edit?usp=sharing"
                    target="_blank"
                    className="text-s font-mono uppercase text-accent flex flex-row gap-2 hover:underline transition-all hover:text-accent/80"
                  >
                    View allotment status <ArrowRight />
                  </a>
                </div>
                {/* Executive Board */}
                <div className="mt-10">
